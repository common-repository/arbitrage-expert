...
Version: 2.0.1
Author URL: https://www.arbitrage.expert
...
function arb_exp_plugin_options_menu()
{
    ...
    <div class="wrap iframe-admin">
        ...
        <div class="inputs-elem">
            <?php foreach ($iframeDef as $value) { ?>
                <input id="<?php echo $value['id'] - 1; ?>" name="<?php echo $value['id'] - 1; ?>" type="hidden"
                       value="<?php echo $value['text']; ?>">
            <?php } ?>
        </div>
